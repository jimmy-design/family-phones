...
export default function Inventory() {
  ...
  return (
    <div className="w-full h-full flex flex-col bg-white border rounded-2xl shadow-md overflow-hidden">
      {/* Header */}
      ...
      <div className="flex-1 overflow-auto p-4">
        <div className="overflow-x-auto">
          <table className="w-full min-w-[800px] text-sm text-gray-700 border-collapse">
              ...
              {inventory.length > 0 ? (
                inventory.map((item) => (
                  <tr key={item.id} className="border-b hover:bg-gray-50">
                    ...
                    <td className="px-3 py-2">Ksh {item.price}</td>
                    <td className="px-3 py-2">Ksh {item.offer_price}</td>
