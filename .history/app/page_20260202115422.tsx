          ...
          {!activeFeature && (
            <>
              ...
              >
                ...
                <div className="flex flex-row flex-wrap md:grid md:grid-cols-3 gap-4 py-2">
                  {(statistics.length > 0 ? statistics : (current.stats || [])).map((stat, idx) => {
                    ...
                    return (
                      <div key={idx} className="p-4 rounded-2xl text-center flex-1 min-w-0 overflow-hidden">
                        <div className="text-base sm:text-lg md:text-2xl lg:text-3xl font-bold truncate leading-tight">
