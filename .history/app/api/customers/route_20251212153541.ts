...
export async function POST(request: Request) {
  ...
  // Build the insert object - explicitly exclude customer_id to let DB auto-generate
  ...
  if (error) {
    ...
    if (error.code === "23505") {
      ...
      return NextResponse.json({
        error: "A customer with this information already exists. Please check the ID number or phone number.",
