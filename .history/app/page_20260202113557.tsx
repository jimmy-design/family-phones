          ...
          {!activeFeature && (
            <>
              ...
              >
                ...
                <div className="flex flex-row md:grid md:grid-cols-3 gap-4 overflow-x-auto py-2">
                  {(statistics.length > 0 ? statistics : (current.stats || [])).map((stat, idx) => {
                    ...
                    return (
                      <div key={idx} className="p-4 bg-white/10 rounded-2xl text-center min-w-[170px] flex-shrink-0">
