          ...
          {!activeFeature && (
            <>
              ...
              >
                ...
                <div className="flex flex-row flex-nowrap md:grid md:grid-cols-3 gap-4 py-2">
                  {(statistics.length > 0 ? statistics : (current.stats || [])).map((stat, idx) => {
                    ...
                    return (
                      <div key={idx} className="p-4 rounded-2xl text-center flex-1 basis-0 min-w-0 overflow-hidden">
