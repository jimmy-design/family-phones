  ...
  useEffect(() => {
    async function fetchStatistics() {
      try {
        ...
        const totalSales = invoices?.reduce((sum, invoice) => sum + (Number(invoice.amount_paid) || 0), 0) || 0;
        const totalOwed = invoices?.reduce((sum, invoice) => sum + (Number(invoice.balance_due) || 0), 0) || 0;
